  ...
  void _showDeleteConfirmationDialog() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text("ยืนยันการลบฐานข้อมูล"),
          content: const Text("คุณแน่ใจหรือไม่ว่าต้องการล้างข้อมูลทั้งหมด?"),
          actions: [
            TextButton(
              onPressed: () {
            ...
            TextButton(
              onPressed: () async {
                ...
                _loadCities();
                print("✅ Database cleared and UI reloaded!");
              },
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          child: const Icon(Icons.cleaning_services_outlined, color: Colors.white),
        ),
      ),
    );
  }
